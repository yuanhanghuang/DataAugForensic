...
#         self.norm= nn.SyncBatchNorm(outChannels)#LayerNorm(outChannels, eps=1e-6, data_format="channels_first")
...
class ConvBNReLU(nn.Module):
    ...
    def __init__(self, in_c, out_c,
        ...
        self.conv = nn.Conv2d(in_c, out_c,
                              ...
                              groups=groups,
                              bias=False)
        self.bn = LayerNorm(out_c, eps=1e-6, data_format="channels_first")#nn.BatchNorm2d(out_c)
        self.act = nn.ReLU(inplace=True)
