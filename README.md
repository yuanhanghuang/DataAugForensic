...
# Model
We provide the [model weights](https://pan.quark.cn/s/1e64222b9ac6) trained on the CASIAv2 dataset for use. Simply download the file and place it in the "./models" folder. 
