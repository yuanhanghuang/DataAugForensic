...
# Model
We provide the [model weights](https://pan.quark.cn/s/1e64222b9ac6) trained on the CASIAv2 dataset to verify the effectiveness of our approach. Simply download the file and place it in the "./models" folder. 
